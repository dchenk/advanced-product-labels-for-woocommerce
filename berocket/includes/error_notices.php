...
class BeRocket_error_notices {
	...
	public function __construct() {
		add_action("wp_ajax_berocket_error_notices_get", [__CLASS__, 'get_plugin_error_ajax']);
	}

	public static function add_plugin_error($plugin_id, $message, $data = []) {
	...
	public static function clear_plugin_errors($plugin_id) {
		self::save_plugin_error($plugin_id, []);
	}
